...
geom_line(color="green") + labs(title = "Expectativa de vida en Colombia", x= "Expectativa de Vida", y= "Año")+theme_solarized(light=FALSE)  + scale_colour_solarized('green')+theme(text = element_text(family = "serif"), plot.title = element_text(face = "bold", hjust = 0.5))
```
